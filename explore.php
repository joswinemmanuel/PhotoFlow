                        ...
                        <div class="people__column">
                            <?php if($curr_us != $usernamee){?>
                                <?php if($ifFollowing == 1){ ?>
                                    <a href="unfollow.php?follower=<?php echo $curr_us?>&unfollowing=<?php echo $usernamee?>&for=<?php echo $for_us?>&get=<?php echo $get?>&return=explore" class="login__input--btn">Following</a>
                                <?php }else{?>
                                    <a href="follow.php?follower=<?php echo $curr_us?>&following=<?php echo $usernamee?>&for=<?php echo $for_us?>&get=<?php echo $get?>&return=explore" class="login__input--btn">Follow</a>
                                <?php } 
                            }?>       
                        </div>
                    </li>
