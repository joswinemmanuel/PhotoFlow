        ...
        <div class="popUp">
            ...
            <div class="popUp__container">
                <div class="popUp__buttons">
                    <a href="index.php" style="border-radius: 15px; border: 1px solid rgba(0,0,0,0.2);" class="popUp__button">Log Out</a>
                    <br>
                    <a href="#" style="border-radius: 15px; border: 1px solid rgba(0,0,0,.2);" class="popUp__button" id="cancelPopUp">Cancel</a>
                </div>
            </div>
        </div>
        <script
